...
import com.langyage.treasury.databinding.FragmentFolderCreateBinding
...
class FolderCreateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFolderCreateBinding.inflate(inflater, container, false)
        val root = binding.root;

        val folderControllder = FolderController(root.context, activity)
        ...
        binding.folderActionBtn.setOnClickListener {
            ...
            if(nameText.isBlank() || colorText.isBlank())
                ...
                folderControllder.addFolder(FolderData(nameText, colorText)){
